...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        imageAtm = new ImageView("com/houarizegai/atm/resources/images/atm.jpg");
        ...
        manImage = new ImageView[Constants.MEN_NAME.length];
        
        for (int i = 0; i < manImage.length; i++) {
            manImage[i] = new ImageView("com/houarizegai/atm/resources/images/" + Constants.MEN_NAME[i] + ".png");
        ...
        btnStart.setOnAction(e -> {
            ...
            for(int i = 0; i < Integer.parseInt(numberOfUserComboBox.getValue().toString()); i++)
                new Person(machine, Constants.MEN_NAME[i], mutex);
        ...
        scene.getStylesheets().add("com/houarizegai/atm/resources/css/style.css");
